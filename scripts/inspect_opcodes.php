<?php
/**
 * Opcode Inspection Demo
 */

$key = "0123456789abcdef0123456789abcdef";
putenv("KAGE_ENCRYPTION_KEY=" . $key);

echo "=== ZEND ENGINE OPCODES IN KAGE (PHP 8.4) ===\n\n";
...
echo "[2] STANDARD ZEND ENGINE OPCODES (Zend Engine 4.4):\n";
...
file_put_contents('/tmp/test_dump.kage', $raw_bytes);
...
echo "--------------------------------------------------------\n";
include '/tmp/test_dump.kage';
echo "\n--------------------------------------------------------\n";
@unlink('/tmp/test_dump.kage');
